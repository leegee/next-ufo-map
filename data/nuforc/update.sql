...
ALTER TABLE sightings RENAME COLUMN date_time TO datetime;
ALTER TABLE sightings RENAME COLUMN city_area TO city;
ALTER TABLE sightings RENAME COLUMN ufo_shape TO shape;
ALTER TABLE sightings RENAME COLUMN encounter_length TO duration_seconds;
ALTER TABLE sightings RENAME COLUMN description TO report_text;
ALTER TABLE sightings RENAME COLUMN date_documented TO date_posted;

ALTER TABLE sightings 
  ALTER COLUMN datetime TYPE DATE USING TO_DATE(datetime, 'MM/DD/YYYY'),
  ADD COLUMN source VARCHAR(25) CHECK (source IN ('nuforc')),
